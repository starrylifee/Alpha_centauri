...
const Hints = (function () {
    ...
    const hintData = {
        ...
        4: {
            text: '💡 힌트 4: 로켓이 날아가는 동안 외행성(조난자)도 움직입니다! 외행성이 1초에 도는 각도는 360을 외행성 주기로 나누면 나옵니다. 여기에 로켓 편도 시간을 곱하면 로켓이 나는 동안 외행성이 움직이는 각도가 나오고, 외행성이 도착 지점보다 그만큼 "뒤에" 있을 때 발사하면 됩니다!',
            used: false
        }
    };
